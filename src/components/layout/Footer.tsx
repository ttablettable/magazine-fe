...
const Footer: React.FC = () => {
  return (
    <div className={styles.footer}>
      ...
      <div className={styles.footerWrap}>
        <Link className={styles.footerLink} draggable="false" href="/about">
          About
        </Link>
        •
        <Link className={styles.footerLink} draggable="false" href="/backlog">
          Backlog
        </Link>
        •
        <Link className={styles.footerLink} draggable="false" href="/terms">
          Terms
        </Link>
        •
        <Link className={styles.footerLink} draggable="false" href="/privacy">
          Privacy
        </Link>
        {/*•
        <Link className={styles.footerLink} draggable="false" href="/help">
          Help
        </Link>*/}
      </div>
      <div className={styles.footerWrap}>
        ...
        <Link
          className={styles.footerIcon}
          href="https://www.are.na/brian-felix/gf8svz9f554"
          target="_blank"
        >
